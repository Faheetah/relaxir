defmodule RelaxirWeb.UserAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, RelaxirWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      RelaxirWeb.Endpoint.subscribe(live_socket_id)
  ...
  describe "fetch_current_user/2" do
    ...
    @tag skip: "lot of gibberish that doesn't match"
    ...
    @tag skip: "should not be returning back a binary"
