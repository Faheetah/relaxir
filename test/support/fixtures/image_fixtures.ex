defmodule Relaxir.ImageFixtures do
  @moduledoc """
  This module defines test helpers for creating image data.
  """

  @one_pixel_jpg <<0xFF, 0xD8, 0xFF, 0xE0, 0x00, 0x10, 0x4A, 0x46, 0x49, 0x46, 0x00, 0x01, 0x01, 0x01, 0x00, 0x48, 0x00, 0x48, 0x00, 0x00,
                   ...
                   0x00, 0x00, 0x00, 0x00, 0xFF, 0xDA, 0x00, 0x08, 0x01, 0x01, 0x00, 0x00, 0x3F, 0x00, 0xD2, 0xCF, 0x20, 0xFF, 0xD9>>

  def one_pixel_jpg do
    @one_pixel_jpg
  end

  def one_pixel_jpg_size do
    byte_size(@one_pixel_jpg)
  end
end
